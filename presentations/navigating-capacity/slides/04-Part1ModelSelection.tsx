...
/**
 * Part 1 Section Divider - Model Selection
 */
export function Part1ModelSelection({ active }: Props) {
    ...
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      <div ref={containerRef} className="relative z-10 flex flex-col items-center justify-center h-full">
        <div className="text-center">
          <p className="part-label text-cyan-400 text-lg font-medium tracking-[0.3em] uppercase mb-6">
            Part 1
          </p>

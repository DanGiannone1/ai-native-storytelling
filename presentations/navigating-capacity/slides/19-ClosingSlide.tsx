 ...
 */
export function ClosingSlide({ active }: Props) {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(subtitle, { opacity: 0 }, { opacity: 1, duration: 0.8, delay: 1.0 })
    gsap.fromTo(takeaways, { opacity: 0, y: 20, scale: 0.9 }, { opacity: 1, y: 0, scale: 1, duration: 0.5, stagger: 0.1, delay: 1.4, ease: 'back.out(1.4)' })
  }, [active])
  ...
  return (
    <div className={`slide ${active ? 'active' : ''}`}>
      <div ref={containerRef} className="relative flex flex-col items-center justify-center h-screen overflow-hidden">
        ...
        {/* Convergence animation effect - same as intro */}
        <div className="convergence-effect absolute inset-0 pointer-events-none">
          <svg className="w-full h-full" viewBox="0 0 1000 600">
            ...
            <circle cx="500" cy="300" r="200" fill="url(#closingGlow)" />
            ...
            {[...Array(12)].map((_, i) => {
              ...
              return (
                <circle key={i} r={3 + (i % 3)} fill={color} filter="url(#closingGlowFilter)">
        ...
        <div className="z-10 text-center px-8">
          <h1 className="main-title text-6xl md:text-7xl font-bold tracking-wide mb-4">

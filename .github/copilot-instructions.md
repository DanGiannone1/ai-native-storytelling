# AI Native Storytelling - Copilot Instructions
...
- GSAP for complex animations, Framer Motion for component-level

## Animation Guidelines
- Only animate GPU-accelerated properties: `transform`, `opacity`, `filter`, `clip-path`
- Use `hasAnimated` guard pattern to prevent re-animation on every render
- Stagger entries with `stagger: 0.1` for visual rhythm
- Ease functions: `power2.out` for entrances, `back.out(1.4)` for playful pops

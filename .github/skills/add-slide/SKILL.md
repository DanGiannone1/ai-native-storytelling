---
name: add-slide
description: Add a new slide to an existing presentation with appropriate template selection based on content type
argument-hint: "{presentation-name} {slide-title}"
user-invokable: true

...
const icons: Record<IconName, React.ReactElement> = {
  ...
  Server: <><rect x="2" y="3" width="20" height="4" rx="1" /><rect x="2" y="9" width="20" height="4" rx="1" /><rect x="2" y="15" width="20" height="4" rx="1" /></>,
...
export function Icon({ name, size = 24, strokeWidth = 1.5, className = '', style }: IconProps) {
